...
function App() {
  ...
  return (
    <div
      className={`min-h-screen bg-mesh transition-colors duration-300 ${darkMode ? "dark" : ""}`}>
      <Navigation
        darkMode={darkMode}
      ...
      <main className="transition-all duration-300">
        ...
        {(showProgram1 ||
          ...
          showProgram11 ||
          showProgram12) && (
          <section className="py-24 px-4 min-h-[80vh]">
            <div className="max-w-5xl mx-auto">
              <div className="card shadow-2xl shadow-brand-500/5 animate-in fade-in slide-in-from-bottom-4 duration-500">
    ...
    res[j] = '\\0';
                  ...
                  {showProgram3 && (
                    <div className="space-y-10">
                      <div className="space-y-2">
                        <span className="text-brand-600 dark:text-brand-400 text-sm font-bold uppercase tracking-widest">
                          Laboratory Module 03
                        </span>
                        <h2 className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                          Stack Operations & Palindromes
                        </h2>
                      </div>
                            ...
                            <OutputPanel
                              output={
                                programOutput.length === 0
                                  ? "// Select an action or enter choice to start..."
                                  : programOutput.join("\n")
                              }
                              darkMode={darkMode}
                            />
                    ...
                    <div className="space-y-10">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                        <div className="space-y-6">
                          ...
                          <CodeBlock
                            code={`void infixToPostfix(char infix[], char postfix[]) {
    push('#');
    while ((symbol = infix[i++]) != '\\0') {
        if (symbol == '(') push(symbol);
        else if (isalnum(symbol)) postfix[j++] = symbol;
        else if (symbol == ')') {
                        ...
                        <div className="space-y-8">
                          ...
                          <div className="space-y-4">
                            ...
                            <OutputPanel
                              output={
                                programOutput.length === 0
                                  ? "// Postfix result will appear here..."
                                  : programOutput.join("\n")
                              }
                              darkMode={darkMode}
                            />
